...
As of 2026-09-18: **32 verified, 7 unverified, 1 proposed** (40 entries).
...
Still unverified (7): Textarea, File Input, Alert — Error (Form Validation),
Document Upload — Attachment Panel, Empty State — Standalone Paragraph,
Empty State — Table Row, Combobox (Long-List Select).
